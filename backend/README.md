...
## Project Structure
    ...
    ├── frosty_glitter_dev_57902  # Django project configurations
...
1. Clone this repo and `cd frosty_glitter_dev_57902`
...
2. Clone this repo and `cd frosty_glitter_dev_57902`
