"""
Django settings for frosty_glitter_dev_57902 project.
...
ROOT_URLCONF = 'frosty_glitter_dev_57902.urls'
...
WSGI_APPLICATION = 'frosty_glitter_dev_57902.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_glitter_dev_57902 API",
    "DESCRIPTION": "API documentation for frosty_glitter_dev_57902 App",
    "VERSION": "v1",
}
